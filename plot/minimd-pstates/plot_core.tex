...
\begin{tikzpicture}
  \begin{axis}[ 
    ...
    %% 3.2 GHz start point
    \pgfmathsetmacro{\obie}{38.455411521685186}
    \pgfmathsetmacro{\cbie}{23.864427452610958}
    \addplot[name path=edpdef, draw=none, domain=\cbie:\codetime+1, forget plot] {definitionbound(\codepower, \codetime, x, 2)};
    \addplot[name path=edpopt, draw=none, domain=\codetime-1:\obie, forget plot] {metricbound(\codepower, \codetime, x, 2)};
