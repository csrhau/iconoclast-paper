\begin{tikzpicture}
  \begin{axis}[ticks = none,
    ...
    \addplot[name path=energyopt, forget plot, domain=\orie:\obie, thick, gray] {metricbound(\codepower, \codetime, x, \delayexponent)};
    \addplot[name path=energylimit, forget plot, domain=\cbie:\lrie, thick, gray]{metricbound(\baselinepower, \cbie, x, \delayexponent)};
    \addplot[name path=energydef, domain=\cbie:\codetime, thick, gray] {definitionbound(\codepower, \codetime, x, \delayexponent)};
    ...
    \addplot[name path=energyopt, forget plot, domain=\orie:\obie, thick, darkgray] {metricbound(\codepower, \codetime, x, \delayexponent)};
    \addplot[name path=energylimit, forget plot, domain=\cbie:\lrie, thick, darkgray]{metricbound(\baselinepower, \cbie, x, \delayexponent)};
    \addplot[name path=energydef, domain=\cbie:\codetime,thick, darkgray] {definitionbound(\codepower, \codetime, x, \delayexponent)};
