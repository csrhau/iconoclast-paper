...
\begin{tikzpicture}
  \begin{axis}[ticks = none, 
    ...
    \node[circle,fill,inner sep=1pt] at (axis cs:\codetime+8,\codeenergy+150) {};
    \node[above right] at (axis cs:\codetime+8,\codeenergy+150) {$\lambda_{power}$};
    

    \node[circle,fill,inner sep=1pt] at (axis cs:\codetime-2,\codeenergy+150) {};
    \node[above left] at (axis cs:\codetime-2,\codeenergy+180) {$\lambda_{time}$};
