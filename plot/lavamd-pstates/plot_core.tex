...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[printblue!50] fill between[of=edpspace and basebound]; 
    ...
    \addplot[printblue!25] fill between[of=edpspace and basebound]; 
    \addlegendentry{First Non-intersecting POSE}
    ...
    \addplot[darkgray, densely dotted, domain=\blnodex:\codetime, forget plot] {definitionbound(\codepower, \codetime, x, 2)};
