\begin{tikzpicture}
  ...
  \begin{axis}[ticks = none, 
    ...
    \addplot+[domain=\pgfkeysvalueof{/pgfplots/xmin}:\pgfkeysvalueof{/pgfplots/xmax}] {\baselinepower * x};
    \addlegendentry{$P_{\alpha}$ zoot Energy Bound} 
    % BETA ROOFLINE BOUND
    \addplot+[domain=\pgfkeysvalueof{/pgfplots/xmin}:\pgfkeysvalueof{/pgfplots/xmax}] {\rooflinepower * x};
