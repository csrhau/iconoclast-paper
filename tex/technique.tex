...
The POSE heuristic partitions the Energy/Runtime plane into areas with different performance characteristics relative to some initial unoptimised code $\theta$ for metric $M$.
...
The dashed Optimisation Limit  mirrors the Optimisation Bound and is also based on \autoref{eq:optimisation}.
...
\todo{reword, probably smash into the above}
The insights listed above fall broadly into two broad categories.
