...
As previously mentioned, power optimization of a given code depends on whether we canreduce either activity factor or frequency without compromising runtime.

\todo{
  \begin{enumerate}
    \item Nature of supported metrics
    \item Bring in equations
  \end{enumerate}
}
