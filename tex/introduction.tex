...
The development of new energy-aware performance engineering tools and techniques will help developers to identify and capitalise on this new class of optimisation.

In this paper we present the Power Optimised Software Envelope (POSE).
POSE is a mathematical and visual modelling tool which provides insight into the energy consumption characteristics of a code.
