...
\begin{table}
  ...
  Analytical & LogP~\cite{culler:1993aa}, LogGP~\cite{alexandrov:1995aa} & BTL~\cite{manousakis:2012aa}, CAPE~\cite{kamble:1997aa} \\
...
Frameworks like LogGP~\cite{alexandrov:1995aa} and BTL~\cite{manousakis:2012aa} provide model skeletons which must then be tailored to individual codes.
