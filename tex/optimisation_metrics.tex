...
Metrics combining both runtime and energy costs have been developed.
The simplest of these is the Energy Delay Product (EDP) metric \cite{gonzales:1996aa}, defined as:
\begin{align}
...
Most examples in this paper use $E^1t^2$, which is arguably the most appropriate $E^mt^n$ metric when considering a fixed micro-architecture \cite{brooks:2000aa}.
