...
We also show ahat no power optimised version of MiniMD operating below 2.3 GHz can match the $\mathbf{ED^2P}$ performance of the original code running at 3.2 GHz.
