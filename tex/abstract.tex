...
We demonstrate POSE by studying the CPU power consumption of two molecular dynamics miniapps.
For MiniMD we find that the potential energy savings from power optimisation are limited to XXX.
We also show reducing runtime by XXX\% yields better results than all possible power optimisations in terms of Energy Delay Squared Product.
