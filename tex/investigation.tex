...
Overriding DVFS with \texttt{cpufrequtils} allowed us to measure the performance of our codes at every P-state.
\autoref{fig:pstates} shows that for both codes this approach can reduce energy consumption at the cost of increased runtime.
...
The corresponding feasible performance envelope is given by \autoref{eq:pbfreq}.
\begin{align}
  \label{eq:pbfreq}
  \begin{split}
