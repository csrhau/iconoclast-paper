...
\noindent
We use POSE to investigate the CPU power consumption of codes from the Mantevo~\cite{heroux:2009aa} and Rodinia~\cite{che:2009aa} benchmark suites.
...
\begin{figure*}[t]%
  \providecommand{\plotwidth}{.80\linewidth}
