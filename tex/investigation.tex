...
\todo{Say we're focussing on CPU power consumption}
...
A runtime optimisation of 4.84s, or 1.19x, is guaranteed to beat any power optimized version of $\theta$ in terms of $Et^2$ 
...
A runtime optimisation of 13.06s, or 1.25x, is guaranteed to beat any power optimized version of $\theta$ in terms of $Et^2$ 
