...
As miniapps, applications from both suites have well understood structures and relatively compact code bases.
They also exhibit a range of power consumption characteristics making for interesting comparisons.

POSE is platform agnostic, applying equally well from the single CPU level to large systems.
For our first study with POSE we have decided to focus on 
